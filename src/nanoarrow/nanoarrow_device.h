...
NANOARROW_EXPORT ArrowErrorCode ArrowDeviceCheckRuntime(struct ArrowError* error);
...
NANOARROW_EXPORT void ArrowDeviceArrayViewInit(
...
NANOARROW_EXPORT ArrowErrorCode ArrowDeviceArrayViewSetArray(
    struct ArrowDeviceArrayView* device_array_view, struct ArrowDeviceArray* device_array,
    struct ArrowError* error);

/// \brief Copy an ArrowDeviceArrayView to a device
NANOARROW_EXPORT ArrowErrorCode ArrowDeviceArrayViewCopy(struct ArrowDeviceArrayView* src,
                                                         struct ArrowDevice* device_dst,
                                                         struct ArrowDeviceArray* dst);
...
NANOARROW_EXPORT struct ArrowDevice* ArrowDeviceCpu(void);

/// \brief Initialize a user-allocated device struct with a CPU device
NANOARROW_EXPORT void ArrowDeviceInitCpu(struct ArrowDevice* device);
...
NANOARROW_EXPORT struct ArrowDevice* ArrowDeviceResolve(ArrowDeviceType device_type,
                                                        int64_t device_id);

NANOARROW_EXPORT ArrowErrorCode ArrowDeviceBufferInit(struct ArrowDevice* device_src,
                                                      struct ArrowBufferView src,
                                                      struct ArrowDevice* device_dst,
                                                      struct ArrowBuffer* dst);

NANOARROW_EXPORT ArrowErrorCode ArrowDeviceBufferMove(struct ArrowDevice* device_src,
                                                      struct ArrowBuffer* src,
                                                      struct ArrowDevice* device_dst,
                                                      struct ArrowBuffer* dst);

NANOARROW_EXPORT ArrowErrorCode ArrowDeviceBufferCopy(struct ArrowDevice* device_src,
                                                      struct ArrowBufferView src,
                                                      struct ArrowDevice* device_dst,
                                                      struct ArrowBufferView dst);
...
NANOARROW_EXPORT ArrowErrorCode ArrowDeviceBasicArrayStreamInit(
