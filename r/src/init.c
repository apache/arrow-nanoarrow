...
extern SEXP nanoarrow_c_make_altrep_string(SEXP array_view_xptr);
extern SEXP nanoarrow_c_make_altrep_integer(SEXP array_view_xptr);
...
static const R_CallMethodDef CallEntries[] = {
    {"nanoarrow_c_make_altrep_string", (DL_FUNC)&nanoarrow_c_make_altrep_string, 1},
    {"nanoarrow_c_make_altrep_integer", (DL_FUNC)&nanoarrow_c_make_altrep_integer, 1},
