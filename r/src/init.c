...
extern SEXP nanoarrow_c_make_altstring(SEXP array_view_xptr);
extern SEXP nanoarrow_c_altrep_class(SEXP x_sexp);
...
static const R_CallMethodDef CallEntries[] = {
    {"nanoarrow_c_make_altstring", (DL_FUNC)&nanoarrow_c_make_altstring, 1},
    {"nanoarrow_c_altrep_class", (DL_FUNC)&nanoarrow_c_altrep_class, 1},
